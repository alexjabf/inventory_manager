(function(jQuery) {
    ...
    jQuery.railsAutocomplete.fn.extend({init: function(e) {
            ...
            jQuery(e).autocomplete({source: function(request, response) {
                    jQuery.getJSON(jQuery(e).attr("data-autocomplete"), {term: extractLast(request.term), current_controller: singular_controller_name}, function() {
