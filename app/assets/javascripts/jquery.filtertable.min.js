 ...
 */(function(e) {
    var t = e.fn.jquery.split("."), n = parseFloat(t[0]), r = parseFloat(t[1]);
    ...
    e.fn.filterTable = function(t) {
        var n = {callback: null, containerClass: "filter-table", containerTag: "div", hideTFootOnFilter: !1, highlightClass: "alt", inputName: "", inputType: "search", label: "", minRows: 5, placeholder: "Buscar en la tabla", quickList: [], quickListClass: "quick", quickListGroupTag: "", quickListTag: "a", visibleClass: "visible"}, r = function(e) {
            return e.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
        }, i = e.extend({}, n, t), s = function(e, t) {
            var n = e.find("tbody");
            if (t === "") {
        ...
        return this.each(function() {
            var t = e(this), n = t.find("tbody"), o = null, u = null, a = null;
