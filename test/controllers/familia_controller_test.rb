...
class FamiliaControllerTest < ActionController::TestCase
  ...
  test "should create familium" do
    assert_difference('Familium.count') do
      post :create, familium: { FamClave: @familium.FamClave, FamDescripcion: @familium.FamDescripcion, idFamilia: @familium.idFamilia }
    end
  ...
  test "should update familium" do
    patch :update, id: @familium, familium: { FamClave: @familium.FamClave, FamDescripcion: @familium.FamDescripcion, idFamilia: @familium.idFamilia }
    assert_redirected_to familium_path(assigns(:familium))
  end
